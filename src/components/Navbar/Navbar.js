    ...
    <div className='h-[60px] bg-[#0f172a] text-white col-span-12'>
        <div className='customContainer flex items-center h-full'>
            <div className='customGridRange relative flex justify-end items-center h-full group'>
                ...
                {totalPrice>0 &&<div className="hidden group-hover:flex items-center absolute p-2 bg-STGrey rounded-lg top-[62px] -right-10  z-50">
                  Total Price : <GetIcon name='TakaIcon' className="w-5 h-5"  /> {totalPrice}
                </div>}
            </div>
        </div>
    </div>
